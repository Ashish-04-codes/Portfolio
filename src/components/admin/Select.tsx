...
export const Select: React.FC<SelectProps> = React.memo(
  ({ label, error, helperText, options, placeholder, children, className = '', ...props }) => {
    return (
      <div className="w-full">
        ...
        <select
          className={`w-full px-4 py-2 border-2 border-ink font-body text-base focus:outline-none focus:ring-2 focus:ring-ink/20 bg-newsprint ${
