 ...
 * Shows uploaded logo image if available, otherwise falls back to the SVG banana logo.
 */
export const NanoBananaLogo: React.FC<LogoProps> = ({
    className = '',
    onClick,
    logoUrl,
    siteTitle = 'The Daily Developer',
    tagline = 'The daily dose of potassium and code',
}) => {
    return (
        <div
