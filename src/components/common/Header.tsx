 ...
 * Uses SiteConfigContext for dynamic title, tagline, location, and logo
 */
export const Header: React.FC<HeaderProps> = ({
  ...
  const { siteTitle, tagline, location, logoUrl } = useSiteConfig();
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
        <div className="flex flex-col items-center justify-center relative">
          ...
          <div
            ...
            className="flex items-center justify-center gap-4 cursor-pointer hover:scale-[1.01] transition-transform duration-300"
          >
            {logoUrl && (
              <img
                src={logoUrl}
            ...
            <h1 className="font-masthead text-5xl md:text-7xl lg:text-9xl tracking-tight text-center leading-none">
              {siteTitle}
            </h1>
          </div>
          <div className="text-sm font-mono italic mt-2">"{tagline}"</div>
        </div>
      </div>
