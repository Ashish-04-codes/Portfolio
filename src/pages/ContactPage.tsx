  ...
  if (loading) {
    return (
      <div className="text-center py-12">
        <p className="font-mono text-sm">Loading contact information...</p>
      </div>
    );
  }
        ...
        <div className="relative z-10 space-y-8">
          ...
          <div className="text-center space-y-4 border-b-2 border-ink pb-6">
            ...
            <p className="font-headline italic text-lg md:text-xl max-w-lg mx-auto leading-relaxed text-ink/80">
              {profile?.bio?.split('\n')[0] ||
                'Seeking a digital architect? Fill out the slip below and post it immediately for a prompt telegraph response.'}
            </p>
          ...
          <form className="space-y-8 mt-8" onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
              ...
              <div className="group">
                <label
                  htmlFor="name"
                  className="block text-xs font-bold uppercase tracking-widest mb-2 font-mono group-focus-within:text-ink-light transition-colors"
                >
                  01. Full Name
                </label>
                <input
            ...
            <div className="space-y-3">
              <span className="block text-xs font-bold uppercase tracking-widest mb-1 font-mono">
                03. Nature of Inquiry
              </span>
            ...
            <div className="group relative">
              ...
              <div className="relative w-full">
                <textarea
                  ...
                  style={{
                    backgroundImage:
                      'repeating-linear-gradient(transparent, transparent 31px, rgb(var(--rgb-ink) / 0.1) 31px, rgb(var(--rgb-ink) / 0.1) 32px)',
                    lineHeight: '32px',
                    padding: '8px 12px',
                  }}
                ></textarea>
              </div>
              <p className="text-[10px] text-right mt-1 font-mono italic opacity-60">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-4">
              <div className="flex items-center gap-4 order-2 md:order-1">
                ...
                >
                  {/* Placeholder Text */}
                  <div
                    className={`text-[10px] font-mono text-center leading-tight uppercase transition-opacity duration-300 ${isStamped ? 'opacity-0' : 'opacity-50 group-hover/stamp:opacity-80'}`}
                  >
                    Place
                    <br />
                    Stamp
                  ...
                  {/* The Stamp Graphic */}
                  <div
                    className={`absolute inset-0 flex items-center justify-center pointer-events-none transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] ${isStamped ? 'opacity-100 scale-100 rotate-[-12deg]' : 'opacity-0 scale-[2.0] rotate-12'}`}
                  >
                    <div className="w-20 h-20 rounded-full border-4 border-double border-ink flex flex-col items-center justify-center text-ink bg-ink/5 p-1 mask-ink shadow-sm">
                      <Stamp size={28} />
                      <span className="text-[8px] font-bold font-mono uppercase mt-1 tracking-widest">
                        Postage
                        <br />
                        Paid
                      </span>
                ...
                <p className="text-xs max-w-[200px] font-headline italic leading-tight opacity-80">
                  By posting this letter, you agree to receive a digital response within 1-2
                  business days.
                </p>
              </div>
