    ...
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="max-w-2xl w-full text-center">
        ...
        <p className="font-body text-lg text-ink/70 max-w-md mx-auto mb-4 drop-cap">
          The page you are looking for has either been moved, misplaced during printing, or perhaps
          never existed in this edition. Our editorial team has been notified.
        </p>
