    ...
    const projects = [
      {
        ...
        shortDesc:
          'A comprehensive data visualization suite for enterprise-level financial tracking. Features real-time websocket updates.',
        fullDesc:
        ...
        challenge:
          'Rendering 50,000+ data points in real-time caused significant DOM trashing and frame rate drops on standard React rendering cycles.',
        solution:
          'Implemented a hybrid approach using Canvas API for heavy charts and React for UI controls. utilized Web Workers to parse incoming WebSocket messages off the main thread, maintaining a steady 60fps.',
      ...
      },
      {
        ...
        fullDesc:
          'A cross-platform mobile application for a digital-first bank. The focus was on extreme accessibility (WCAG AAA compliance) and "instant" interactions.',
        image: 'https://picsum.photos/400/300?grayscale',
        techStack: ['React Native', 'Redux Toolkit', 'Node.js'],
        challenge:
          'Achieving native-like transition smoothness while maintaining a shared codebase for iOS and Android.',
        solution:
          'Utilized Reanimated 2 for purely native-driver animations and implemented optimistic UI updates to mask network latency during transactions.',
      ...
      },
      {
        ...
        fullDesc:
          'An open-source library providing a flexible, flexbox-based grid system for React applications. It mimics the Bootstrap grid but with a smaller footprint and typed props.',
        techStack: ['React', 'NPM', 'Rollup'],
        challenge:
          'Maintaining backward compatibility while migrating the library to support React Server Components.',
        solution:
          'Adopted a monorepo structure to publish separate ESM and CJS builds, ensuring compatibility across Next.js app directory and legacy Create React App projects.',
        links: { repo: 'https://github.com' },
        featured: false,
        published: true,
      },
      {
        ...
        fullDesc:
          'A headless e-commerce storefront built for a luxury fashion brand. The site integrates with Shopify Plus for checkout but uses a custom frontend for browsing and storytelling.',
        techStack: ['Next.js', 'GraphQL', 'Stripe', 'Vercel'],
        challenge:
          'The client required heavy imagery and video content without compromising Core Web Vitals.',
        solution:
          'Implemented aggressive image optimization using next/image, lazy-loading strategies, and edge-caching for static assets to achieve a Lighthouse score of 98.',
      ...
      },
      {
        ...
        fullDesc:
          'A collection of algorithmic artworks generated via code. These pieces explore the relationship between organized chaos and mathematical precision.',
        ...
        solution:
          ' utilized Perlin noise and flow fields to simulate natural textures like topography and fluid dynamics.',
        links: { demo: 'https://example.com' },
        featured: false,
        published: true,
      },
      {
        ...
        fullDesc:
          'This archive contains older projects including my first portfolio, a PHP forum, and various jQuery plugins. Kept for nostalgia and to measure growth.',
        featured: false,
        published: true,
      },
    ];
      ...
      content: [
        {
          type: 'paragraph',
          content:
            'There is a peculiar rhythm to the life of a software engineer. It is syncopated by the release cycles of major frameworks, punctuated by the deprecation warnings in our terminals, and underscored by a persistent anxiety that we are falling behind. We build cathedrals on foundations of sand, not because we lack stone, but because the sand merchants have better marketing departments.',
        },
        {
          type: 'paragraph',
          content:
            'Consider the humble `div`. It has survived the browser wars, the rise and fall of Flash, and the tumultuous transition from table-based layouts to Flexbox. Yet, in our quest for abstraction, we have buried it under layers of hydration logic and state management libraries that promise simplicity while delivering complexity on an installment plan.',
        },
        {
          type: 'blockquote',
          content:
            'We build cathedrals on foundations of sand, not because we lack stone, but because the sand merchants have better marketing departments.',
        },
        {
          type: 'paragraph',
          content:
            'The modern stack is a marvel of engineering, to be sure. But one must ask: are we solving problems, or are we merely solving the problems created by our previous solutions? The React component you wrote three years ago is now considered "legacy" not because it stopped working, but because the paradigm of how to write it has shifted three times since.',
        },
      ],
      published: true,
      featured: true,
      ...
      sections: [
        {
          ...
          content:
            "I believe that performance is a feature, not an afterthought. Whether it's optimizing Core Web Vitals or reducing bundle sizes, I ensure that applications are fast, accessible, and resilient. My approach is data-driven, using metrics to guide architectural decisions.",
          order: 0,
        },
        {
          ...
          content:
            "The web is constantly changing, and so am I. Currently, I am exploring the potential of Server Components, Edge Computing, and WebAssembly to push the boundaries of what's possible in the browser.",
          order: 1,
        },
      ],
      vitals: {
